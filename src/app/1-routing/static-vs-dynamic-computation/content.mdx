...
- **generateStaticParams**: Generated static params does not cover new params. (See [Dogs Example](/1-routing/static-vs-dynamic-computation/dogs/Retriever)). This can be disabled by adding `dynamicParams = false`
